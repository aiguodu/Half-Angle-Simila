  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 md:p-6 flex items-center justify-center font-sans">
      <div className="flex flex-col w-full max-w-6xl mx-auto bg-slate-50 rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        {/* Header */}
        <header className="bg-white h-16 px-6 border-b border-slate-200 flex justify-between items-center shrink-0">
              ...
              <AnimatePresence>
                {showQuestion && (
                  <motion.div initial={{ opacity: 0, y: 10, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 10, scale: 0.95 }} className="absolute z-50 top-full left-0 mt-2 p-2 bg-white rounded-xl shadow-2xl border border-slate-200 w-[400px]">
                    ...
                    <img src="/images/10-1.png" alt="题目原题" className="w-full h-auto rounded-lg border border-slate-100" />
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="bg-slate-100 p-5 rounded-xl border border-slate-200">
                  <h3 className="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">详细推导过程</h3>
        ...
        {/* Footer */}
        <footer className="bg-white h-20 px-6 border-t border-slate-200 grid grid-cols-3 items-center shrink-0">
